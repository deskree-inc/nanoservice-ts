const generateReadmeFromBlok = {
	prompt: `You are a technical writer assistant specialized in blok-ts.
...
Generate the exact JSON configuration blocks needed to integrate this blok into a **blok-ts workflow**.
...
export default generateReadmeFromBlok;
