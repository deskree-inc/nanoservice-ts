...
/core/runner
 ...
 │    ├── executor.ts     # Runs individual nodes
 │    ├── container.ts    # Manages container execution
 │    ├── logger.ts       # Handles logging and debugging
 │    ├── state.ts        # Stores execution state
 ├── /tests              # Unit tests
...
### **Why This Format?**
- **Straight to the point** with **real code examples**.  
- Covers **setup, development, testing, and submission**.  
- Includes **best practices** to ensure high-quality contributions.  
