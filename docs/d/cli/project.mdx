...
Managing **nanoservice-ts** projects effectively starts with the `blokctl` CLI. This section focuses on commands related to project creation and overall project lifecycle management, primarily the `create project` command.

## `create project`

This is typically the first `blokctl` command you will use when starting a new **nanoservice-ts** application.
...
When you run `npx blokctl@latest create project`, the CLI will typically guide you through a series of prompts:
