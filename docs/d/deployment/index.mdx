...
After successful deployment, you'll receive a URL where your service is hosted (typically `https://YOUR_PROJECT_NAME.deskree.com`).
...
For example, if you have a workflow defined in `workflows/json/countries.json`, you can access it at:

```
https://YOUR_PROJECT_NAME.deskree.com/countries
```
...
- [How to Deploy Nanoservices Seamlessly with Deskree](https://medium.com/nanoservice/how-to-deploy-nanoservices-seamlessly-with-deskree-8c4b15ff8acc) - Detailed blog post about deployment
- [Deployment Video Tutorial](https://www.youtube.com/watch?v=V46GpIUE-9E) - Step-by-step video guide for deploying to Deskree
- [Nanoservice-TS Documentation](https://nanoservice.xyz) - Official documentation
...
<iframe 
  ...
  title="How to Deploy your Nanoservice-TS project on Deskree" 
  frameborder="0" 
